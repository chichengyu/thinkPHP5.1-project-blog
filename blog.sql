...
CREATE TABLE IF NOT EXISTS `blog_article` (
  ...
  `pic` varchar(150) NOT NULL COMMENT '缩略图',
...
INSERT INTO `blog_article` (`id`, `title`, `author`, `desc`, `keywords`, `content`, `pic`, `click`, `state`, `time`, `cateid`) VALUES
...
INSERT INTO `blog_cate` (`id`, `catename`) VALUES
(1, '美食'),
(2, '健身'),
(3, '养生'),
(4, '服装'),
...
INSERT INTO `blog_links` (`id`, `title`, `url`, `desc`) VALUES
...
INSERT INTO `blog_tags` (`id`, `tagname`) VALUES
(1, '趣事'),
(2, '奇闻2'),
(4, '测试');
